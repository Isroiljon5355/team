...
function Another() {
  return (
    <div className="ml-[15px]">
      ...
      <div className="flex md:flex mt-[12px]">
        <div className="group relative overflow-hidden cursor-pointer">
          <div className="relative">
            <img
              className="rounded-lg w-[330px] mr-2 object-cover"
              src="https://hostim-html.themetags.com/assets/img/home3/ft-7.jpg"
              alt=""
            />
            <div className=" absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black"></div>
            <div className="w-[92%] sm:w-[53%] md:w-[92%] md:top-[14%] h-[140px] lg:w-[92%] lg:top-[17%] xl:w-[92%]  inset-0 translate-y-[100%] group-hover:translate-y-0 transition-all xl:top-[20%] absolute  mx-auto left-[4%] backdrop-blur-[33px] p-[20px] rounded-lg text-white bg-[rgba(0,0,0,.6)]">
