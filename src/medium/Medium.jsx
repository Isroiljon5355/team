          ...
          <div className="md:flex">
            <div className="relative mt-[20px]">
              <img
                ...
                alt=""
              />
              <div className="w-[92%] md:w-[52%] sm:w-[53%] absolute top-[68%] mx-auto left-[4%] backdrop-blur-[33px] p-[20px] rounded-lg text-white bg-[rgba(0,0,0,.6)]">
            ...
            <div className="relative mt-[20px]">
              ...
              <img
                ...
                alt=""
              />
              <div className="w-[92%] sm:w-[53%] md:w-[52%]  absolute top-[68%] mx-auto left-[4%] backdrop-blur-[33px] p-[20px] rounded-lg text-white bg-[rgba(0,0,0,.6)]">
                <h1 className="text-[15px] font-extrabold ">
                  Assassin's Creed Valhalla
                </h1>
                <div className="flex">
