      ...
      <div className="flex justify-between relative py-[20px] px-[10%] ">
        <div className="mr-[20px]  ">
          <img className="rounded-lg"
            ...
            alt=""
          />
          <div className="w-[33%] h-[200px] absolute top-[55%] mx-[37px] backdrop-blur-[33px] p-[20px] rounded-lg text-white bg-[rgba(0,0,0,.6)] sm:grid-cols-1   ">
            <h1 className="text-[30px] font-extrabold ">Assassin's Creed Valhalla</h1>
            <div className="flex ">
            ...
            <div className="flex justify-between text-center">
              <div className="">
                ...
                <p className="font-medium ">PS4, PS5, Xbox One, Xbox Series X</p>
              </div>
        ...
        <div className="around">
          ...
          <div className="flex mt-[10px] mt-[18px] ">
            <div className="mr-[22px]">
              ...
              <h1 className="text-[15px] font-extrabold ">Assassin's Creed Valhalla</h1>
              <div className="flex">
                <p className="font-medium">$26.00</p>
